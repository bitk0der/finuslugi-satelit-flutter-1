                    ...
                    title: Row(children: [
                      ClipRRect(
                        ...
                        child: SizedBox(
                            ...
                            height: 46.w,
                            child:
                                Image.network(widget.coupon.retailer.imageUrl)),
                      ),
                      SizedBox(width: 12.w),
                      Flexible(
                        child: Column(
                            ...
                            Row(
                              children: [
                                SizedBox(
                                    ...
                                    height: 22.w,
                                    child:
                                        Assets.images.couponDiscount.image()),
                                SizedBox(width: 6.w),
                            ...
                            Container(
                              ...
                              child: Container(
                                  padding: EdgeInsets.only(
                                      top: 14.h,
                                      bottom:
                                          widget.coupon.total <= 3 ? 0 : 8.h),
                                  decoration: DottedDecoration(
                                      linePosition: LinePosition.top,
                                      color: ColorStyles.black
                                          .withValues(alpha: 0.1)),
                                  child:
                                      _buildExpandableContent(widget.coupon)),
                            ),
