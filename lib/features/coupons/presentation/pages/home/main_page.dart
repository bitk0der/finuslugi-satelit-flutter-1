...
class CouponsMainPage extends StatefulWidget {
  final String? category;
  final String? categoryTitle;

  final Key? key;

  const CouponsMainPage({this.category, this.categoryTitle, this.key})
      : super(key: key);

  @override
  State<CouponsMainPage> createState() => _CouponsMainPageState();
}

class _CouponsMainPageState extends State<CouponsMainPage> {
  ...
  void initState() {
    ...
    _remoteCouponsBloc.add(
        SearchCoupons(searchText: searchString, category: widget.category));
  ...
  Widget build(BuildContext context) {
    return BlocListener<LocalCouponsBloc, LocalCouponsState>(
                        ...
                        child: Column(children: [
                          ...
                          if (state is Failed)
                            ...
                            _pagingController.itemList!
                                    .where(
                                        (element) => element.coupons.isNotEmpty)
                                    .isEmpty
                                ? Center(
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(
                                ...
                                : Expanded(
                                    child: PagedListView<int, CouponModel>(
