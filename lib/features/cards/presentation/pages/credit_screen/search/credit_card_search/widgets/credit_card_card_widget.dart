          ...
          Row(
            children: [
                    ...
                    if (creditCard.additionalImageUrl.isNotEmpty) ...[
                      ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: AppImageNetwork(UiUtil.getlogoUrl(
                                creditCard.additionalImageUrl)),
                          ),
                        ),
                      ),
                      SizedBox(width: 12.w),
              ...
              CardsFavouriteButton(
                isInCard: true,
                onTapFavourite: () => GetIt.I<LocalMortgageBloc>()
                    .add(AddMortgageToFavourite(productItemModel: creditCard)),
                id: creditCard.id,
              )
            ],
          ),
                    ...
                    builder: (context, state) {
                      return AppSmallButton(
                          ...
                          iconColor: GetIt.I<StorageUtil>()
                                  .checkInFavourite(creditCard.id)
