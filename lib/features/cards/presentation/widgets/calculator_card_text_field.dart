...
class CalculatorCardTextField extends StatefulWidget {
  ...
  @override
  _CalculatorCardTextFieldState createState() =>
      _CalculatorCardTextFieldState();
}

class _CalculatorCardTextFieldState extends State<CalculatorCardTextField> {
